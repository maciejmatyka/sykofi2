...
Sprezyna *AlokujSprezyne(float c, float dlugosc, float spr, Punkt *p1, Punkt *p2, int flaga)
{
...
void DodajSprezyne(Sprezyna *korzen, float c, float dlugosc, float spr, Punkt *p1, Punkt *p2, int flaga)
{
	Sprezyna *Robocza;

	for(Robocza=korzen;Robocza->prawy != NULL; Robocza=Robocza->prawy);

	Robocza->prawy=AlokujSprezyne(c,dlugosc,spr,p1,p2, flaga);
}
