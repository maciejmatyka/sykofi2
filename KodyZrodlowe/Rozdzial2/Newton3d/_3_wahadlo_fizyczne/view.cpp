...
*/
	...
	glVertex3f(P(2)->r.x,P(2)->r.y,P(2)->r.z);
	glColor3f(0.3,0.3,0.3);
	glVertex3f(P(3)->r.x,P(3)->r.y,P(3)->r.z);
	glColor3f(0.4,0.4,0.4);
	glVertex3f(P(4)->r.x,P(4)->r.y,P(4)->r.z);


	glColor3f(0.5,0.5,0.5);
	glVertex3f(P(5)->r.x,P(5)->r.y,P(5)->r.z);
	glColor3f(0.3,0.3,0.3);
	glVertex3f(P(3)->r.x,P(3)->r.y,P(3)->r.z);
	glColor3f(0.4,0.4,0.4);
	glVertex3f(P(4)->r.x,P(4)->r.y,P(4)->r.z);
	...
	glVertex3f(P(6)->r.x,P(6)->r.y,P(6)->r.z);
	glColor3f(0.2,0.2,0.2);
	glVertex3f(P(2)->r.x,P(2)->r.y,P(2)->r.z);
	...
	glVertex3f(P(7)->r.x,P(7)->r.y,P(7)->r.z);
