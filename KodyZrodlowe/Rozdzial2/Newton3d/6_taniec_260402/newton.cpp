...
#define a 0.13 
	...
	DodajPunkt(KorzenPunktow,0.1,P_NORM|P_WEKT,Wektor(0.0,2.5*a*0.5,0),Wektor(0,0,0),0);		// 12   glowa
   	...
   	DodajObszar(KorzenObszarow,0.09,Wektor(0,0,0),0.5,O_AKT|O_RYS,Ostatni(KorzenPunktow));
												
	DodajPunkt(KorzenPunktow,0.05,P_NORM|P_WEKT,Wektor(3.7*a,0.3*a,0),Wektor(0,0,0),0);		// 13 // rece		
	DodajPunkt(KorzenPunktow,0.05,P_NORM|P_WEKT,Wektor(-3.7*a,0.3*a,0),Wektor(0,0,0),0);		// 14
